...
This section gives experimental data on the efficiency of the implementation. The efficiency is quantified as the number of comparisons made when performing an operation in the \code{Dictionary} interface.
