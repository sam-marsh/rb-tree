...
The \code{add(Object)} and \code{delete(Object)} methods (\code{delete(Object)} described below) are where my implementation has similarities to the red-black tree detailed in CLRS. 
